...
<frame frameborder=”0″>
  ...
  <div id="wrapper">
    ...
    <input type="hidden" name= "id" value="<?php echo $_SESSION["idCustomer"];?>">
      ...
      <div class="form-group row justify-content-left">
        <label class="col-sm-3 col-form-label text-right"><b>Completed Address of the rented premises (including city & state)<span style="color:red;">*</span></b></label>
        <div class="col-sm-6">
        <input type="text" name="address" class="form-control" value="" required>
        </div>
      </div>
      <div class="form-group row justify-content-left">
        <label class="col-sm-3 col-form-label text-right"><b>Your Tradename/ Firm name/Company name<span style="color:red;">*</span></b></label>
        <div class="col-sm-6">
        <input type="text" name="company" class="form-control" value="" required>
        </div>
      </div>
      <div class="form-group row justify-content-left">
        <label class="col-sm-3 col-form-label text-right"><b>City<span style="color:red;">*</span></b></label>
        <div class="col-sm-6">
    ...
    $( "#date" ).datepicker();
      ...
      <center>
        <button type="submit" class="btn btn-success">Download NOC for signature</button>
      </center>
    </form>
    <div id="link">
