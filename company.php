...
<frame frameborder=”0″>
  ...
  <div id="wrapper">
   ...
   <div class="dropdown-container">
     <center><a href="proprietorView.php">Proprietor</a><br></center>
     <center><a href="company.php">Company</a><br></center>
     <center><a href="PropGST.php">LLP</a><br></center>
...
<!---  
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <table class="table table-striped table-bordered">
          <tbody>
            ...
            <tr><td><center>PhotoGraphs(for All Directors)</center></td><td><center>PhotoGraphs(for All Directors)</center></td></tr>
            <tr><td><center>Self Attested PAN(for All Directors)</center></td><td><center>Self Attested PAN(for All Directors)</center></td></tr>
            <tr><td><center>Self Attested Adhaar(for All Directors)</center></td><td><center>Self Attested Adhaar(for All Directors)</center></td></tr>
      ...
      --------------------->
      <tr><td><center><a type="button" class="btn btn-success" href="GSTDataCo.php">Proceed (self-owned)</a></center></td>
            <td><center><a type="button" class="btn btn-success" href="GSTFormCo.php">Proceed (rented)</a></center></td></tr>
          </tbody>
        </table>
        </div>
      </div>
