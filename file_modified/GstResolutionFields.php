...
<frame frameborder=”0″>
  ...
  <div id="wrapper">
    ...
    <input type="hidden" name= "id" value="<?php echo $_SESSION["idCustomer"];?>">
      ...
      <div class="form-group row justify-content-left">
        <label class="col-sm-3 col-form-label text-right"><b>Director identification number (DIN)  (<a href="http://www.mca.gov.in/mcafoportal/viewCompanyMasterData.do">Click here</a> to know your DIN)<span style="color:red;">*</span></b></label>
        <div class="col-sm-6">
