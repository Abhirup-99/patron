    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
		...
		<input type="hidden" name= "id" value="<?php echo $_SESSION["idCustomer"];?>">
			...
			<div class="form-group row justify-content-left">
				<label class="col-sm-3 col-form-label text-right"><b>Your self-attested PAN in PDF format only<span style="color:red;">*</span></b></label>
				<div class="col-sm-6">
			...
			<div class="form-group row justify-content-left">
				<label class="col-sm-3 col-form-label text-right"><b>Your self-attested Adhaar in PDF format only<span style="color:red;">*</span></b></label>
				<div class="col-sm-6">
