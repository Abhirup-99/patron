  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <form action="customerGSTDataBack.php" method="post" enctype="multipart/form-data">
		<input type="hidden" name= "id" value="<?php echo $_SESSION["idCustomer"];?>">
			...
			<div class="form-group row justify-content-left">
				<label class="col-sm-3 col-form-label text-right"><b>Photographs of all directors<span style="color:red;">*</span></b></label>
				<div class="col-sm-6">
			...
			<div class="form-group row justify-content-left">
				<label class="col-sm-3 col-form-label text-right"><b>Self-attested copy of PAN for all directors in PDF format only<span style="color:red;">*</span></b></label>
				<div class="col-sm-6">
				<input type="file" name="PAN" class="form-control" value="" required>
				</div>
			</div>
			...
			<div class="form-group row justify-content-left">
				<label class="col-sm-3 col-form-label text-right"><b>Self-attested copy of Adhaar for all directors in PDF format only<span style="color:red;">*</span></b></label>
				<div class="col-sm-6">
				<input type="file" name="Adhaar" class="form-control" value="" required>
				</div>
			</div>
			<div class="form-group row justify-content-left">
				<label class="col-sm-3 col-form-label text-right"><b>Cancelled cheque or unprotected bank statement or first page of pass book (Self attested for bank statement in PDF format only)<span style="color:red;">*</span></b></label>
				<div class="col-sm-6">
				<input type="file" name="Cheque" class="form-control" value="" required>
				</div>
			</div>
			<div class="form-group row justify-content-left">
				<label class="col-sm-3 col-form-label text-right"><b>Signed NOC from owner<span style="color:red;">*</span></b></label>
				<div class="col-sm-6">
				<input type="file" name="NOC" class="form-control" value="" required>
				</div>
			</div>	
