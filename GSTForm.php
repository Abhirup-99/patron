    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
		...
		<input type="hidden" name= "id" value="<?php echo $_SESSION["idCustomer"];?>">
			...
			<div class="form-group row justify-content-left">
				<label class="col-sm-3 col-form-label text-right"><b>In case you are operating from rented premises the upload the NOC from owner of property in PDF format<span style="color:red;">*</span></b></label>
