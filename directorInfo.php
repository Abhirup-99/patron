...
<frame frameborder=”0″>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <form action="directorInfoBack.php" method="post" enctype="multipart/form-data" id="form">
          <h3>Director Details</h3>
          <input type="hidden" name= "id" value="<?php echo $_SESSION['idCompanyDirector'];?>">
          <div class="form-group row justify-content-left">
            <label class="col-sm-3 col-form-label text-right"><b>Name<span  style="color:red;">*</span></b></label>
            <div class="col-sm-6">
              <input type="text" name="name" class="form-control" value="" required>
            </div>
          </div>
          <div class="form-group row justify-content-left">
            <label class="col-sm-3 col-form-label text-right"><b>Photograph<span  style="color:red;">*</span></b></label>
            <div class="col-sm-6">
              <input type="file" name="photograph" class="form-control" value="" required>
            </div>
          </div>
          <div class="form-group row justify-content-left">
            <label class="col-sm-3 col-form-label text-right"><b>Adhaar<span  style="color:red;">*</span></b></label>
            <div class="col-sm-6">
              <input type="file" name="adhaar" class="form-control" value="" required id="adhaar">
            </div>
          </div>
          <div class="form-group row justify-content-left">
            <label class="col-sm-3 col-form-label text-right"><b>PAN<span  style="color:red;">*</span></b></label>
            <div class="col-sm-6">
              <input type="file" name="pan" class="form-control" value="" required id="pan">
            </div>
          </div>
          <center>
          <button type="submit" class="btn btn-primary">Submit and Add another</button>
          <button type="button" class="btn btn-warning" onclick="submitInfo()">Finish</button>
          </center>
        </form>        
      </div>
      <!-- /.container-fluid -->
 ...
 <script type="text/javascript">
   function submitInfo(){
    ...
    name.action='directorFinish.php';
    name.submit();
   }
 </script>
