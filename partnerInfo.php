  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <form action="partnerInfoBack.php" method="post" enctype="multipart/form-data" id="director">
		<div class="headings">Proposed LLP Details</div>
		<br>
		<input type="hidden" name= "llpId" value="<?php echo $_SESSION["idLlp"];?>">
			...
			<center>
			<button type="button" class="btn btn-warning" onclick="change()">Finish</button>
			<button type="submit" class="btn btn-success">Submit and Add Another</button>
...
<script type="text/javascript">
	function change(){
		var id = document.getElementById('director');
		id.action = 'partnerFinish.php';
		id.submit();
	}
</script>