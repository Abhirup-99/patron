...
{
	if(filesize($_FILES['PAN']['name'])>1000000)
	{
		clearstatcache();
		$a=1;
	...
	if(filesize($_FILES['Adhaar']['name'])>1000000)
	{
		clearstatcache();
		$a=1;
	...
	if(filesize($_FILES['Cheque']['name'])>1000000)
	{
		clearstatcache();
		$a=1;
	...
	if(filesize($_FILES['Address']['name'])>1000000)
	{
		clearstatcache();
		$a=1;
	...
	if(filesize($_FILES['Rent']['name'])>1000000)
	{
		clearstatcache();
		$a=1;
